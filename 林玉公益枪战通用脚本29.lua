...
local function createNoticePage()
    ...
    local logs = {
        {date = "2025.07.19", ver = "v2.9", text = "UI全面重构，新增漏打检测变色"},
...
local function isOnOrb(pos)
    ...
    return pos.X >= orbPos.X - 12 and pos.X <= orbPos.X + orbSize.X + 12
       and pos.Y >= orbPos.Y - 12 and pos.Y <= orbPos.Y + orbSize.Y + 12
end
...
-- ========== 设置页面 ==========
pages[6] = createFeaturePage("设置", "设置", "脚本配置与个性化", C_TEXT2)

local devCard = Instance.new("Frame")
devCard.Size = UDim2.new(1, 0, 0, 200)
devCard.BackgroundColor3 = C_SURFACE
devCard.BorderSizePixel = 0
devCard.LayoutOrder = 1
devCard.ZIndex = 55
devCard.Parent = pages[6].Container

local dcC = Instance.new("UICorner")
dcC.CornerRadius = UDim.new(0, 16)
dcC.Parent = devCard

local dcStroke = Instance.new("UIStroke")
dcStroke.Color = C_BORDER
...
devDesc.Size = UDim2.new(1, -20, 0, 40)
devDesc.Position = UDim2.new(0, 10, 0, 114)
devDesc.BackgroundTransparency = 1
devDesc.Text = "设置模块正在重构优化\n敬请期待后续版本更新"
devDesc.TextColor3 = C_TEXT2
devDesc.TextSize = 12
devDesc.Font = Enum.Font.Gotham
devDesc.TextWrapped = true
devDesc.ZIndex = 56
devDesc.Parent = devCard

-- 进度条装饰
local progressBg = Instance.new("Frame")
progressBg.Size = UDim2.new(1, -40, 0, 4)
progressBg.Position = UDim2.new(0, 20, 0, 164)
progressBg.BackgroundColor3 = C_SURFACE2
progressBg.BorderSizePixel = 0
progressBg.ZIndex = 56
local pbC = Instance.new("UICorner")
pbC.CornerRadius = UDim.new(1, 0)
pbC.Parent = progressBg
progressBg.Parent = devCard

local progressFill = Instance.new("Frame")
progressFill.Size = UDim2.new(0.35, 0, 1, 0)
progressFill.BackgroundColor3 = C_TEXT2
...
progressText.Size = UDim2.new(0, 60, 0, 16)
progressText.Position = UDim2.new(1, -70, 0, 172)
progressText.BackgroundTransparency = 1
progressText.Text = "35%"
progressText.TextColor3 = C_TEXT3
progressText.TextSize = 10
progressText.Font = Enum.Font.GothamBold
progressText.TextXAlignment = Enum.TextXAlignment.Right
progressText.ZIndex = 56
progressText.Parent = devCard
